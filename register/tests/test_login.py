...
def test_usuario_login_success(django_user_model):
...
@pytest.mark.django_db
def test_usuario_login_fail_email(django_user_model):
...
@pytest.mark.django_db
def test_usuario_login_fail_password(django_user_model):
